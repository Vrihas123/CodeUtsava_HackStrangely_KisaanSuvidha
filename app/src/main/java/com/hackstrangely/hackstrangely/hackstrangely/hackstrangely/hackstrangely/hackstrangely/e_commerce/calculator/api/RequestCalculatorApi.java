...
public interface RequestCalculatorApi {
    ...
    Call<CalculatorList> getCalculatedData(@Query("bed_size") String size, @Query("access_token") String access_token, @Query("bed_lines") String line, @Query("crop") String crop);
