package com.hackstrangely.hackstrangely.hackstrangely.hackstrangely.hackstrangely.hackstrangely.e_commerce.login.provider;
...
public class RetrofitLoginHelper implements LoginBaseClassHelper {
    ...
    @Override
    public void loginData(String mobile, String password,  String access_token, final LoginCallback loginCallback) {
        ...
        Call<LoginDataResponse> call= requestLogin.getJSON(mobile,password,access_token);
